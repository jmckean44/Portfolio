...
$(document).ready(function () {
	...
	jQuery.validator.addMethod(
		...
		function (phone, element) {
			...
			return this.optional(element) || (phone.length > 9 && phone.match(/^((\+[1-9]{1,4}[ \-]*)|(\([0-9]{2,3}\)[ \-]*)|([0-9]{2,4})[ \-]*)*?[0-9]{3,4}?[ \-]*[0-9]{3,4}?$/));
		},
				...
				: (this.attr('novalidate', 'novalidate'),
				  ...
				  c.settings.onsubmit &&
						...
						this.on('submit.validate', function (b) {
							...
							return (
								c.settings.debug && b.preventDefault(), c.cancelSubmit ? ((c.cancelSubmit = !1), d()) : c.form() ? (c.pendingRequest ? ((c.formSubmitted = !0), !1) : d()) : (c.focusInvalid(), !1)
							);
						})),
				  c);
		},
