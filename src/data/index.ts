...
export const items: Item[] = [
	{
		...
		details:
			'Astro JS, Javascript, HTML, CSS, Adobe Animate and Premiere. I was asked to create a multi-language site incorporating video, parallax effects, and animated content. The site is image and video heavy, which made Astro JS a good solution using a customized Picture Component to manage responsive image sizing serving avif, webp, and jpg fallback versions. GSAP handled the parallax effects. The form submits to Onyx Technologies, a real estate software company that use Salesforce to manage leads.',
	...
	},
	{
		...
		slug: 'loreta',
		description:
			'Loreta Beach Resort is a new beach resort that overlooks the Old Town of Primošten, Croatia. I was asked to create a website that would showcase the resort and its amenities, use animated location markers to highlight areas aroudn the resort as well as image with content rollovers for type attractions around Primošten, and connect the web form to Onyx Technologies, a real estate developer software company in Quebec that use Salesforce to manage client leads.',
		details: 'jQuery, PHP, HTML, CSS, Adobe Suite',
